...
from lims.views import (
    ...
    lims_reference_sample_accession_page,
...
urlpatterns = [
    ...
    path(
        ...
        lims_reference_sample_accession_page,
        name='lims_reference_sample_accession_page',
    ),
    ...
    path('api/v1/notifications/dispatch', notification_dispatch, name='notification_dispatch'),
    path('api/v1/notifications/<uuid:notification_id>/retry', notification_retry, name='notification_retry'),
    ...
    path(
        'api/v1/projects/invitations/<uuid:invitation_id>/revoke',
        project_invitation_revoke,
        name='project_invitation_revoke',
    ),
    path(
        'api/v1/projects/invitations/<uuid:invitation_id>/resend',
        project_invitation_resend,
        name='project_invitation_resend',
    ),
